...
export default class Protocal extends React.Component<ProtocalProps> {
  render() {
    return (
      <div className="page p-protocal" style={{ display: this.props.visible ? 'block' : 'none'}}>
        <div className="inner" style={{ padding: '20px'}}>
          ...
          <div className="footer">
            <a onClick={() => this.props.onCancel()}>我不同意以上协议</a>
            <Button type="primary" onClick={() => this.props.onConfirm()}>我已确认并同意以上用户协议</Button>
          </div>
        </div>
      </div>
    );
